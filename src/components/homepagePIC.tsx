...
//@ts-ignore
import indexImageHeadDesktop from "../img/memberPage/1-desktop.jpg";
//@ts-ignore
import indexImageHeadLaptop from "../img/memberPage/1-laptop.jpg";
//@ts-ignore
import indexImageHeadMobile from "../img/memberPage/1-mobile.jpg";
